  ...
  if (isFinished) {
    return (
      <div className="session-finished">
        ...
        <h1 style={{ color: '#10b981', fontSize: '32px' }}>Félicitations !</h1>
        ...
        <p style={{ fontSize: '18px', color: '#4b5563', padding: '0 10px' }}>
          Prenez une pause, buvez un grand verre d'eau, et reposez-vous bien. À demain pour la prochaine séance !
        </p>
